...
Since control architecture is decentralized, each agent has access to its own state, and to the relative states of other agents in the swarm, in addition to the position of the flag 
